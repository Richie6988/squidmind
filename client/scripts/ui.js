const ui = {
  ...
  async updateStats() {
    // Removed: the top-bar model dot. Poseidon himself is the living system
    // indicator now (golden trident when loaded, steel + Zzz when cold) —
    // a second dot for the same signal was an artifact.
  },
